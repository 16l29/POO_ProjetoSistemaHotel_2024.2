...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BotaoLimpar.setBounds(57, 213, 130, 24);
        ...
        BotaoSalvar.setForeground(new Color(128, 0, 0));
        BotaoSalvar.setFont(new Font("Segoe UI", Font.BOLD, 12));
        BotaoSalvar.setFocusPainted(false);
        BotaoSalvar.setBackground(Color.WHITE);
        BotaoSalvar.setBounds(495, 215, 130, 24);
        Inicio.getContentPane().add(BotaoSalvar);
        ...
        background.setBounds(0, -33, 700, 299);
